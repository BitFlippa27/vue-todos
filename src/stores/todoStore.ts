...
export const useTodoStore = defineStore('todoStore', {
  ...
  getters: {
    ...
    searchedTodos: (state: State) => (filteredTodos: Todo[]): Todo[] => {
    ...
    filteredByPriority: (state: State) => (filteredTodos: Todo[]): Todo[] => {
      return filteredTodos.slice().sort((a, b) => a.priority - b.priority)
    },
    filteredByDate: (state: State) => (filteredTodos: Todo[]): Todo[] => {
